...
$dokter = query("SELECT * FROM dokter_spkk");
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="warnakita">Daftar Dokter</h1>
                        ...
                        <table class="table1" border="1">
                            <tr>
                                ...
                                <th width="290px"> <center> <b> Nama Dokter </b> </center> </th>
                                <th width="280px"> <center> <b> Email </b> </center> </th>
                                <th width="150px"> <center> <b> Biaya Konsultasi </b> </center> </th>
                            </tr>
                            <?php $i = 1; ?>
                            ...
                            <tr>
                                <td> <?= $i ?> </td>
                                <td>
                                    <a href="ubah_dokter.php?id=<?= $row["id"]; ?>"> Ubah </a> |
                                    <a href="hapus_dokter.php?id=<?= $row["id"]; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?');"> Hapus </a>
                                </td>
